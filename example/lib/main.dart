...
Future<void> initializeCloudKit() async
{
  ...
  await CKAPIManager.shared.initManager(ckContainer, ckAPIToken, ckEnvironment, navigatorKey: navigatorKey);
  CKLocalDatabaseManager.shared.initDatabase(recordStructures);
}
