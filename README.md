...
3. [Model Classes](#model-classes)
   ...
   b. [Supported Field Types](#supported-field-types)
   c. [Custom Field Types](#custom-field-types)
   d. [Reflection Setup](#reflection-setup)
4. [API Initialization](#api-initialization)
5. [Usage](#usage)
   a. [Operations](#operations)
   b. [Request Models](#request-models)
